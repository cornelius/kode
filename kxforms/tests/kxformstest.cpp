...
void KXFormsTest::testHints()
{
    ...
    QCOMPARE(mHints.hint("version").value(KXForms::Hint::ListItemLabel),
             QString("<itemLabelArg ref=\"product/name\" /> (v%1)"));
    ...
    QCOMPARE(mHints.hint("documentationstatus").value(KXForms::Hint::GroupReference),
             QString("documentation"));

    QCOMPARE(mHints.hint("documentationstatus").value(KXForms::Hint::Appearance), QString("full"));

    QCOMPARE(mHints.hint("documentationstatus").value(KXForms::Hint::Label),
             QString("Status of the documentation: "));
