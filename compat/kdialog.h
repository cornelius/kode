...
public:
    enum ButtonCode {
        ...
        No = 0x00000080, ///< Show No button. (this button close the dialog and set the result to
                         ///< No)
        Yes = 0x00000100, ///< Show Yes button. (this button close the fialog and set the result to
                          ///< Yes)
        Details = 0x00000400, ///< Show Details button. (this button will show the detail widget set
                              ///< with setDetailsWidget)
        ...
        NoDefault ///< Used when specifying a default button; indicates that no button should be
                  ///< marked by default.
    };
